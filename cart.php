                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td class="price"><span> &#x20B9 <?php echo $cart_list[$x][3]; ?></span></td>
                                                <td class="qty">
                                                    <div class="quantity">
                                                ...
                                                <td class="total_price"><span> &#x20B9 <?php echo $cart_list[$x][2] * $cart_list[$x][3]; ?></span></td>
                                            </tr>
                                    <?php
                                        }
                                    ?>
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="cart-total-area mt-70">
                            ...
                            <ul class="cart-total-chart" id="cart_total">
                                <li><span>Subtotal</span> <span> &#x20B9 <?php echo $cart_total; ?></span></li>
                                <li><span>Shipping</span> <span>Free</span></li>
                                <li><span><strong>Total</strong></span> <span><strong> &#x20B9 <?php echo $cart_total; ?></strong></span></li>
                            </ul>
