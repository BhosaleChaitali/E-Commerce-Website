                    ...
                    <div class="row h-100 align-items-center justify-content-end">
                        ...
                        <div class="col-12 col-lg-7">
                            <div class="top_single_area d-flex align-items-center">
                                <!-- Logo Area -->
                                <div class="top_logo">
                                    <a href="#"><img src="img/core-img/TRENDYy.png" alt=""></a>
                                </div>
                                <!-- Cart & Menu Area -->
                                <div class="header-cart-menu d-flex align-items-center ml-auto">
                                    ...
                                    <div class="cart" id="cart">
                                        ...
                                        ?>
                                        <a href="#" id="header-cart-btn" onclick="cart_open();"><span class="cart_quantity"><?php echo count($cart);?></span> <i class="ti-bag"></i> Your Bag - INR <?php echo $_SESSION["cart_total"];?></a>
                                        ...
                                        <ul class="cart-list">
                                            ...
                                            ?>
                                            <li class="total">
                                                <span class="pull-right">Total: INR <?php echo $cart_total;?></span>
                ...
                <div class="container h-100">
                    <div class="row h-100">
                        <div class="col-12 d-md-flex justify-content-between">
                            ...
                            <!-- Help Line -->
                            <div class="help-line">
                                <a href="tel:+346573556778"><i class="ti-headphone-alt"></i> +91 76 7123 4567</a>
                            </div>
                        </div>
                    </div>
                </div>
